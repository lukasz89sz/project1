...
public class recognition{
    ...
    public static int recognit() {
        String trainingDir = "C:/facerecognizer";
        Mat testImage = imread("zdjecie.png", CV_LOAD_IMAGE_GRAYSCALE);
        ...
        System.out.println("Osoba: "+  imie+ " " + predictedLabel);
